...
```zsh
pipenv run python3 -m doctest -v main.py
```
...
1 items passed all tests:
   2 tests in main.get_heap_sorted_list
2 tests in 2 items.
...
![](https://res.cloudinary.com/gyunseo-blog/image/upload/f_auto/v1700503951/image_dckxdi.png)
![](https://res.cloudinary.com/gyunseo-blog/image/upload/f_auto/v1700503960/image_bgruno.png)
